<template>
  <div class="container">
    ...
    <small class="text-red d-flex justify-content-end align-items-center mt-2">{{ itemCount }} adet alınacak ürün vardır.</small>
  </div>
</template>
...
export default {
  ...
  mounted(){
    axios.get("http://localhost:3000/items").then(items_response => {
      ...
      console.log("this.itemList :>>", this.itemsList);
    });
  },
  methods: {
    onSave(e) {
